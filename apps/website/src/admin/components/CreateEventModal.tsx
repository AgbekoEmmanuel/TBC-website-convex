            ...
            <div className="space-y-4">
                ...
                <label className="block text-xs font-bold text-slate-500 mb-1.5 uppercase tracking-wide">Event Title</label>
                 <div className="relative">
                   ...
                   <input 
                      ...
                      required 
                      className="w-full pl-10 rounded-xl border border-slate-200 px-3 py-2.5 text-sm focus:border-[#1f4b73] focus:ring-1 focus:ring-[#1f4b73] outline-none transition-shadow bg-white" 
                   />
                 </div>
              </div>
              ...
              <div>
                ...
                <textarea 
                  ...
                  rows={3}
                  className="w-full rounded-xl border border-slate-200 px-4 py-2.5 text-sm focus:border-[#1f4b73] focus:ring-1 focus:ring-[#1f4b73] outline-none transition-shadow bg-white"
                />
              </div>
                    ...
                    <div>
                      ...
                      <div className="space-y-3 bg-white p-4 rounded-xl border border-slate-200">
                        ...
                        <label className="flex items-center gap-3 cursor-pointer group">
                           ...
                           <input type="date" disabled={endType !== 'date'} className="flex-1 rounded-lg border border-slate-200 px-3 py-1.5 text-sm outline-none focus:border-[#1f4b73] focus:ring-1 focus:ring-[#1f4b73] disabled:opacity-50 disabled:bg-slate-50 transition-colors bg-white" />
                        </label>
                      </div>
                    </div>
                 </div>
