...
export function CreateSermonModal({ isOpen, onClose }: CreateSermonModalProps) {
    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 sm:p-6 text-slate-800">
      ...
      <div className="relative w-full max-w-2xl max-h-[90vh] flex flex-col bg-white rounded-3xl shadow-2xl overflow-hidden animate-in fade-in zoom-in-95 duration-200">
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-slate-100 bg-white">
          <h2 className="text-xl font-serif font-semibold text-[#112a46]">Upload New Sermon</h2>
            ...
            <div className="space-y-4">
              <div>
                ...
                <div className="relative">
                  ...
                  <input type="text" value={title} onChange={(e) => setTitle(e.target.value)} placeholder="e.g. The Architecture of Grace" required className="w-full pl-10 rounded-xl border border-slate-200 px-3 py-2.5 text-sm focus:border-[#288096] focus:ring-1 focus:ring-[#288096] outline-none transition-shadow bg-white" />
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input type="text" value={speaker} onChange={(e) => setSpeaker(e.target.value)} placeholder="e.g. Apostle Michael Dadzie" required className="w-full pl-10 rounded-xl border border-slate-200 px-3 py-2.5 text-sm focus:border-[#288096] focus:ring-1 focus:ring-[#288096] outline-none transition-shadow bg-white" />
                  </div>
                </div>
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input type="text" value={series} onChange={(e) => setSeries(e.target.value)} placeholder="e.g. The Book of Romans" className="w-full pl-10 rounded-xl border border-slate-200 px-3 py-2.5 text-sm focus:border-[#288096] focus:ring-1 focus:ring-[#288096] outline-none transition-shadow bg-white" />
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input type="date" value={date} onChange={(e) => setDate(e.target.value)} required className="w-full pl-10 rounded-xl border border-slate-200 px-3 py-2.5 text-sm focus:border-[#288096] focus:ring-1 focus:ring-[#288096] outline-none transition-shadow bg-white" />
                </div>
              </div>

              <div>
                <label className="block text-xs font-bold text-slate-500 mb-1.5 uppercase tracking-wide">Description</label>
                <textarea value={description} onChange={(e) => setDescription(e.target.value)} placeholder="Brief summary of the sermon..." rows={3} className="w-full rounded-xl border border-slate-200 px-4 py-2.5 text-sm focus:border-[#288096] focus:ring-1 focus:ring-[#288096] outline-none transition-shadow bg-white" />
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input type="url" value={videoUrl} onChange={(e) => setVideoUrl(e.target.value)} placeholder="https://..." className="w-full pl-10 rounded-xl border border-slate-200 px-3 py-2.5 text-sm focus:border-[#288096] focus:ring-1 focus:ring-[#288096] outline-none transition-shadow bg-white" />
                  </div>
                </div>
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input type="url" value={audioUrl} onChange={(e) => setAudioUrl(e.target.value)} placeholder="https://..." className="w-full pl-10 rounded-xl border border-slate-200 px-3 py-2.5 text-sm focus:border-[#288096] focus:ring-1 focus:ring-[#288096] outline-none transition-shadow bg-white" />
                  </div>
                </div>
              </div>
            </div>
