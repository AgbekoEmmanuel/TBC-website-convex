...
export function About() {
  return (
    <div className="w-full font-sans">
      ...
      <section className="relative w-full overflow-hidden bg-gradient-to-br from-[#120822] via-[#21113b] md:via-[#321741] to-[#3a1a40] pt-24 md:pt-32 pb-4 md:pb-6">
      ...
      <div className="w-full py-2 md:py-4 overflow-hidden bg-white flex items-center select-none z-20">
        <motion.div 
          animate={{ x: ["0%", "-50%"] }}
      ...
      <section id="mission" className="bg-[#f7f8f9] pt-4 md:pt-6 pb-32">
