...
export function AllBooks() {
  ...
  const books = dbProducts?.filter(p => p.category === 'Books' || p.category === 'Book') || [];
              ...
              >
                <div className="aspect-[3/4] bg-[#f2f4f7] rounded-[24px] overflow-hidden relative shadow-md transition-shadow duration-500 group-hover:shadow-2xl group-hover:shadow-brand-900/10 mb-8">
                  ...
                  <div className="absolute top-6 left-6 flex flex-col gap-2">
                    {/* Since we don't have tags in Convex yet, we can use a generic or omit it. Let's omit or conditionally show Bestseller for idx 0 */}
                    {idx === 0 && (
